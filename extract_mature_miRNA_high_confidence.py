...
high_confidence_FA = "high_conf_mature_v21.fa"
description = "mirbase_hg38_liftover"
output = "hg38_to_hg19_mirBase_v21_high_confidence.gtf"
...
hcHash = {}
fasta_parser = SeqIO.parse(high_confidence_FA, "fasta")
